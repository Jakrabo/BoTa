...
final class TrainingdiaryController extends FormController {
 ...
 public function save($key=null,$urlVar=null){$r=parent::save($key,$urlVar);$this->setRedirect(Route::_('index.php?option=com_jugendtraining&view=trainingdiaries',false));return$r;}
