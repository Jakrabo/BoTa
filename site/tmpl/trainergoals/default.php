...
<div class="table-responsive"><table class="table table-striped jt-mobile-card-table"><thead><tr><th><?php echo Text::_('COM_JUGENDTRAINING_FIELD_ATHLETE');?></th><th><?php echo Text::_('COM_JUGENDTRAINING_COLUMN_TITLE');?></th><th><?php echo Text::_('COM_JUGENDTRAINING_FIELD_TARGET_TYPE');?></th><th><?php echo Text::_('COM_JUGENDTRAINING_FIELD_PROGRESS');?></th></tr></thead><tbody>
<?php foreach($this->goals as $g):$pct=(float)$g->target_value>0?min(100,round((float)$g->current_value*100/(float)$g->target_value)):0;?><tr><td data-label="<?php echo Text::_('COM_JUGENDTRAINING_FIELD_ATHLETE');?>"><?php echo htmlspecialchars($g->athlete_name,ENT_QUOTES,'UTF-8');?></td><td data-label="<?php echo Text::_('COM_JUGENDTRAINING_COLUMN_TITLE');?>"><?php echo htmlspecialchars($g->title,ENT_QUOTES,'UTF-8');?></td><td data-label="<?php echo Text::_('COM_JUGENDTRAINING_FIELD_TARGET_TYPE');?>"><?php echo Text::_('COM_JUGENDTRAINING_TARGET_'.strtoupper($g->target_type));?></td><td data-label="<?php echo Text::_('COM_JUGENDTRAINING_FIELD_PROGRESS');?>"><div class="progress"><div class="progress-bar" style="width:<?php echo $pct;?>%"><?php echo $pct;?> %</div></div></td></tr><?php endforeach;?>
</tbody></table></div>
