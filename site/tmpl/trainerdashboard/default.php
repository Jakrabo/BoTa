...
></span> <?php echo Text::_($s->signal_reason);?></td><td data-label="<?php echo Text::_('COM_JUGENDTRAINING_TRAINING_28_DAYS');?>"><?php echo(int)$s->arrows_28;?> <?php echo Text::_('COM_JUGENDTRAINING_ARROWS');?> / <?php echo(int)$s->minutes_28;?> <?php echo Text::_('COM_JUGENDTRAINING_MINUTES');?></td><td data-label="<?php echo Text::_('COM_JUGENDTRAINING_RESULT_TREND');?>"><?php echo$s->trend>0?'+':'';echo number_format((float)$s->trend,3,',','.');?></td><td data-label="<?php echo Text::_('COM_JUGENDTRAINING_LAST_TRAINING');?>"><?php echo$s->last_training?HTMLHelper::_('date',$s->last_training,Text::_('DATE_FORMAT_LC4')):Text::_('COM_JUGENDTRAINING_NEVER');?></td></tr><?php endforeach;?></tbody></table></div></section>
