...
<div class="table-responsive"><table class="table table-striped jt-mobile-card-table"><thead><tr>
...
<td data-label="<?php echo Text::_('COM_JUGENDTRAINING_FIELD_ATHLETE');?>"><a href="<?php echo Route::_('index.php?option=com_jugendtraining&view=trainerathletedetail&id='.(int)$a->id);?>"><strong><?php echo htmlspecialchars($a->firstname.' '.$a->lastname,ENT_QUOTES,'UTF-8');?></strong></a></td>
<td data-label="<?php echo Text::_('COM_JUGENDTRAINING_TRAINING_GROUPS');?>"><?php echo htmlspecialchars((string)$a->group_names,ENT_QUOTES,'UTF-8');?></td><td data-label="<?php echo Text::_('COM_JUGENDTRAINING_FIELD_CLASS');?>"><?php echo htmlspecialchars((string)$a->class_name,ENT_QUOTES,'UTF-8');?></td><td data-label="<?php echo Text::_('COM_JUGENDTRAINING_FIELD_BOW_TYPE');?>"><?php echo htmlspecialchars((string)$a->bow_type,ENT_QUOTES,'UTF-8');?></td><td data-label="<?php echo Text::_('COM_JUGENDTRAINING_FIELD_PHONE');?>"><?php echo htmlspecialchars((string)$a->phone,ENT_QUOTES,'UTF-8');?></td>
