...
{ public $form; public $item; public function display($tpl=null) { $this->form=$this->get('Form');$this->item=$this->get('Item');ToolbarHelper::title($this->item->id ? 'COM_JUGENDTRAINING_ATHLETE_EDIT' : 'COM_JUGENDTRAINING_ATHLETE_NEW','pencil');ToolbarHelper::apply('athlete.apply');ToolbarHelper::save('athlete.save');ToolbarHelper::save2new('athlete.save2new');ToolbarHelper::cancel('athlete.cancel');parent::display($tpl); } }
