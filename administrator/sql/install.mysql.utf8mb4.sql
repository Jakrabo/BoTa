...
CREATE TABLE IF NOT EXISTS `#__jt_calendar_events` (
  ...
  `training_group_id` int unsigned DEFAULT NULL,
  `published` tinyint NOT NULL DEFAULT 1,
  `created` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `created_by` int unsigned NOT NULL DEFAULT 0,
  `modified` datetime DEFAULT NULL,
  ...
  KEY `idx_jt_calendar_date_end` (`event_date_end`),
  KEY `idx_jt_calendar_audience` (`audience`),
  KEY `idx_jt_calendar_group` (`training_group_id`),
