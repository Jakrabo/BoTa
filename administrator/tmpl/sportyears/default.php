...
<div class="alert alert-info d-flex flex-wrap justify-content-between align-items-center gap-3">
 <div><?php echo Text::_('COM_JUGENDTRAINING_CLASS_TRANSITION_INFO');?></div>
 <button class="btn btn-outline-primary" type="submit" name="task" value="sportyears.applyClassTransition" onclick="return confirm('<?php echo Text::_('COM_JUGENDTRAINING_CLASS_TRANSITION_CONFIRM');?>');">
  <?php echo Text::_('COM_JUGENDTRAINING_APPLY_CLASS_TRANSITION');?>
 </button>
</div>
