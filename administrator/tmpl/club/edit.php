...
?>
<form action="<?php echo Route::_('index.php?option=com_jugendtraining&view=club&layout=edit&id='.(int)$this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate">
