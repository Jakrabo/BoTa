...
?>
<form action="<?php echo Route::_('index.php?option=com_jugendtraining&view=program&layout=edit&id='.(int)$this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate">
  <div class="card"><div class="card-body"><?php echo $this->form->renderFieldset('details'); ?></div></div>
  <div class="card mt-3"><div class="card-header">Zuordnung</div><div class="card-body"><?php echo $this->form->renderFieldset('assignment'); ?></div></div>
